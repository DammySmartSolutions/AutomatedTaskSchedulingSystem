<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="AutomatedTaskSchedulingSystem.ForgotPassword" %>
...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><img class="logo-img" src="assets/images/Fedex-logo.png" alt="logo" width="100" height="100"></a><span class="splash-description">Please enter your Detail</span></div>
            <div class="card-body">
                <form method="post" runat="server">
                    ...
                    <div class="form-group">
                        <input class="form-control form-control-lg" id="txtpassword" type="password" placeholder="New Password" runat="server">
                    </div>
                    <div class="form-group">
