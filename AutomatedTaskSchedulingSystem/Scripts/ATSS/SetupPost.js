    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var datatableVariable = $('#table').DataTable({
                ...
                "columnDefs": [{ "width": "40%", "targets": 0 }, { "width": "10%", "targets": 1 }, { "width": "10%", "targets": 2 }],
                pageLength: 10,
                dom: "Bfrtip",
                buttons: [
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                document.getElementById("MainContent_txtpost").value = Data["Position"];
            ...
            $('#table tbody').on('click', "#btnDelete", function () {
                ...
                var Result = confirm("You are about to delete " + Position + " Position")
                if (Result) {
...
function DeleteItem(ID) {
    ...
    $.ajax({
        ...
        cache: false,
        data: "{}",
        url: "../api/ATSS/DeletePosition?id= " + ID + "",
        success: function (data) {
            //  alert("Task Deleted!");
