    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var datatableVariable = $('#table').DataTable({
                ...
                "columnDefs": [{ "width": "50%", "targets": 0 }, { "width": "30%", "targets": 1 }, { "width": "20%", "targets": 2 }, { "width": "10%", "targets": 3 }],
                pageLength: 10,
                dom: "Bfrtip",
                buttons: [
            ...
            $('#table tbody').on('click', "#btnEdit", function () {
                ...
                document.getElementById("MainContent_empavailid").value = id;


                window.location.href = "AddEmployeeAvailability.aspx?Empid=" + Empid + "&AvailID=" + id;
