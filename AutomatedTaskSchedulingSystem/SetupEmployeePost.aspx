<%@ Page Language="C#" MasterPageFile="~/Site.Master"  Title="Employee Position Setup" AutoEventWireup="true" CodeBehind="SetupEmployeePost.aspx.cs" Inherits="AutomatedTaskSchedulingSystem.SetupEmployeePost" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
   ...
   <link rel="stylesheet" href="../assets/libs/css/style.css?v=4">
                                    ...
                                    <div class="card-body">
                                         ...
                                         <div class="row">
                                             <div class="col-sm-6">
                                                ...
                                                <label for="txtpost" class="col-form-label">Position</label>
    ...
    <script src="Scripts/ATSS/SetupPost.js?v=2"></script>
