<%@ Page Language="C#" MasterPageFile="~/Site.Master"  ClientIDMode="Static" Title="Generate Schedule" AutoEventWireup="true" CodeBehind="GenerateSchedule.aspx.cs" Inherits="AutomatedTaskSchedulingSystem.GenerateSchedule" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-sm-6">
                                                   ...
                                                   <asp:Button  CssClass="btn btn-primary form-control form-control-sm" runat="server" ID="btngenerate" OnClick="btngenerate_Click"       Text="Generate Schedule" />
